...
\begin{Lemma}\label{W120QT_approximation:third2[n>1]}
Пусть $\eta_1$, $\eta_2\in W^1_{2}(Q_{[t_1,t_2]})$, причём $\eta_1(\cdot,t_1)=\eta_2(\cdot,t_2)= 0$. Тогда существуют последовательности $\eta^N_1\in\mathfrak{K}^N_{t_1}[t_1,t_2]$,
